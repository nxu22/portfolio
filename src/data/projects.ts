export interface Project {
  ...
  stage?: string
  /** Shipping state shown beside the stage, e.g. 'In progress' */
  status?: string
  github?: string
  live?: string
  ...
  video?: string
  videoLink?: string
  /** Overrides the default 'Demo' label on the video button */
  videoLabel?: string
  demo?: string
  image?: string
}
    ...
    projects: [
      {
        ...
        tags: ['LangGraph', 'Claude Haiku 4.5', 'Multi-Agent', 'Prometheus', 'Grafana', 'Langfuse', 'Eval Harness', 'PostgreSQL', 'ChromaDB', 'RAG', 'FastAPI'],
